function init() {
  ...
  function nextSlide(pageNumber) {
    ...
    const nextLeft = nextPage.querySelector(".hero .gableft");
    const nextRight = nextPage.querySelector(".hero .gabright");
    const currentLeft = currentPage.querySelector(".hero .gableft");
    const currentRight = currentPage.querySelector(".hero .gabright");
